...
//Compass
// #define CMPS_XOUT_L        0x4A   // R // should it not be (EXT_SENS_DATA_00) 0x49
...
#define CMPS_XOUT_L        EXT_SENS_DATA_00   // R
#define CMPS_XOUT_H        EXT_SENS_DATA_01   // R
#define CMPS_YOUT_L        EXT_SENS_DATA_02   // R
#define CMPS_YOUT_H        EXT_SENS_DATA_03   // R
#define CMPS_ZOUT_L        EXT_SENS_DATA_04   // R
#define CMPS_ZOUT_H        EXT_SENS_DATA_05   // R
